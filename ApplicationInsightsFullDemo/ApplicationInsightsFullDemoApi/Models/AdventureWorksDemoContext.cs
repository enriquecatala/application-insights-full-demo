...
namespace ApplicationInsightsFullDemoApi.Models
{
    public partial class AdventureWorksDemoContext : DbContext
    {
        public AdventureWorksDemoContext()
        {
        }

        public AdventureWorksDemoContext(DbContextOptions<AdventureWorksDemoContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Server=mslearn-appinsights-sqlserver.database.windows.net;Database=AdventureWorksDemo;User ID=administrador;Password=PaSSw0rdñ.");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECAED907C1E");
